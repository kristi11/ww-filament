...
- [Shop System](./docs/shop/README.md) - E-commerce setup and management
- [Appointment Management](./docs/appointments/README.md) - Scheduling and calendar features
- [Configuration](./docs/configuration/README.md) - Customize roles, features, and settings
- [Development Guide](./docs/development/README.md) - Testing and extending functionality
- [Deployment](./docs/deployment/README.md) - Going live with your application
...
WittyWorkflow is open-source software licensed under the [MIT License](./LICENSE.md).
