<div>
    @if($social)
        @if($icons)
            <!-- Social icons for footer bottom section -->
            @if(!empty($social->instagram))
                <a target="_blank" href="{{ 'https://www.instagram.com/'.$social->instagram }}"
                   class="text-gray-500 hover:text-gray-700 font-medium transition duration-300"
            ...
            @endif
        @else
            <!-- Traditional social links for sidebar -->
            <p class="uppercase text-gray-500 font-bold md:mb-6">Socials</p>
            <ul class="list-reset mb-6">
                @if(!empty($social->instagram))
                    <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                        <a target="_blank" href="{{ 'https://www.instagram.com/'.$social->instagram }}"
                           class="no-underline hover:underline font-medium transition duration-300 flex items-center"
