<div>
    ...
    <section id="login" class="bg-white border-b py-8 lg:p-20">
        <div class="{{ $background->loginBackgroundColor }} container flex flex-wrap justify-center mx-auto pb-12 pt-4 rounded-lg shadow-lg">
            @guest()
                ...
                <div class="bg-white gap-0.5 grid grid-cols-1 lg:px-15 m-6 md:{{ $background->loginBackgroundColor }} md:gap-10 md:grid-cols-3 md:p-0 md:shadow-none md:w-4/5 p-6 rounded-lg shadow-lg w-full">
