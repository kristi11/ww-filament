(() => {
    ...
    var Ti = Object.getPrototypeOf, Pi = Object.prototype.hasOwnProperty;
    var xi = (l, h) => () => (h || l((h = {exports: {}}).exports, h), h.exports);
    var Oi = (l, h, a, c) => {
        if (h && typeof h == "object" || typeof h == "function") for (let s of Ci(h)) !Pi.call(l, s) && s !== a && he(l, s, {
            get: () => h[s],
            enumerable: !(c = Si(h, s)) || c.enumerable
        });
        return l
    };
    var Ai = (l, h, a) => (a = l != null ? ki(Ti(l)) : {}, Oi(h || !l || !l.__esModule ? he(a, "default", {
        value: l,
        enumerable: !0
    }) : a, l));
    var _e = xi((yt, It) => {
        (function (h, a) {
            typeof yt == "object" && typeof It == "object" ? It.exports = a() : typeof define == "function" && define.amd ? define([], a) : typeof yt == "object" ? yt.Pusher = a() : h.Pusher = a()
        })(window, function () {
            return function (l) {
                var h = {};
                ...
                return a.m = l, a.c = h, a.d = function (c, s, f) {
                    ...
                    if (s & 1 && (c = a(c)), s & 8 || s & 4 && typeof c == "object" && c && c.__esModule) return c;
                    var f = Object.create(null);
                    if (a.r(f), Object.defineProperty(f, "default", {
                        enumerable: !0,
                        value: c
                    }), s & 2 && typeof c != "string") for (var d in c) a.d(f, d, function (N) {
                        return c[N]
                    }.bind(null, d));
                    return f
                }, a.n = function (c) {
                    var s = c && c.__esModule ? function () {
                        return c.default
                    } : function () {
                        return c
                    };
                ...
                var s = 256, f = function () {
                    ...
                    return b.prototype.encodedLength = function (v) {
                        ...
                        for (var y = this._getPaddingLength(v), w = v.length - y, O = new Uint8Array(this.maxDecodedLength(w)), I = 0, q = 0, M = 0, J = 0, F = 0, z = 0, B = 0; q < w - 4; q += 4) J = this._decodeChar(v.charCodeAt(q + 0)), F = this._decodeChar(v.charCodeAt(q + 1)), z = this._decodeChar(v.charCodeAt(q + 2)), B = this._decodeChar(v.charCodeAt(q + 3)), O[I++] = J << 2 | F >>> 4, O[I++] = F << 4 | z >>> 2, O[I++] = z << 6 | B, M |= J & s, M |= F & s, M |= z & s, M |= B & s;
                        if (q < w - 1 && (J = this._decodeChar(v.charCodeAt(q)), F = this._decodeChar(v.charCodeAt(q + 1)), O[I++] = J << 2 | F >>> 4, M |= J & s, M |= F & s), q < w - 2 && (z = this._decodeChar(v.charCodeAt(q + 2)), O[I++] = F << 4 | z >>> 2, M |= z & s), q < w - 3 && (B = this._decodeChar(v.charCodeAt(q + 3)), O[I++] = z << 6 | B, M |= B & s), M !== 0) throw new Error("Base64Coder: incorrect characters for decoding");
                        return O
                ...
                h.decodeURLSafe = x, h.encodedLength = function (b) {
                ...
                function f(P) {
                    for (var T = new Uint8Array(d(P)), S = 0, C = 0; C < P.length; C++) {
                        ...
                        x < 128 ? T[S++] = x : x < 2048 ? (T[S++] = 192 | x >> 6, T[S++] = 128 | x & 63) : x < 55296 ? (T[S++] = 224 | x >> 12, T[S++] = 128 | x >> 6 & 63, T[S++] = 128 | x & 63) : (C++, x = (x & 1023) << 10, x |= P.charCodeAt(C) & 1023, x += 65536, T[S++] = 240 | x >> 18, T[S++] = 128 | x >> 12 & 63, T[S++] = 128 | x >> 6 & 63, T[S++] = 128 | x & 63)
                    }
                    return T
                }
                ...
                function d(P) {
                    for (var T = 0, S = 0; S < P.length; S++) {
                        ...
                        if (C < 128) T += 1; else if (C < 2048) T += 2; else if (C < 55296) T += 3; else if (C <= 57343) {
                ...
                var c = function () {
                    ...
                    return e.prototype.load = function (t, n, r) {
                        var i = this;
                        if (i.loading[t] && i.loading[t].length > 0) i.loading[t].push(r); else {
                            i.loading[t] = [r];
                            var o = m.createScriptRequest(i.getPath(t, n)), u = i.receivers.create(function (p) {
                        ...
                        var n, r = m.getDocument().location.protocol;
                        return t && t.useTLS || r === "https:" ? n = this.options.cdn_https : n = this.options.cdn_http, n.replace(/\/*$/, "") + "/" + this.options.version
                    ...
                    var t = "See:", n = C.urls[e];
                    if (!n) return "";
                    var r;
                    return n.fullUrl ? r = n.fullUrl : n.path && (r = C.baseUrl + n.path), r ? t + " " + r : ""
                }, b = {buildLogSuffix: x}, v;
                (function (e) {
                ...
                var y = function () {
                    ...
                    function t(n, r) {
                        var i = this.constructor, o = e.call(this, r) || this;
                        return o.status = n, Object.setPrototypeOf(o, i.prototype), o
                    }

                    return t
                }(Error), me = function (e, t, n, r, i) {
                    var o = m.createXHR();
                        ...
                        if (o.readyState === 4) if (o.status === 200) {
                            ...
                            switch (r) {
                                ...
                                case v.ChannelAuthorization:
                                    k = "Clients must be authorized to join private or presence channels. " + b.buildLogSuffix("authorizationEndpoint");
                                    break
                            }
                            i(new B(o.status, "Unable to retrieve auth string from " + r.toString() + " endpoint - " + ("received status: " + o.status + " from " + n.endpoint + ". " + k)), null)
                        }
                    }, o.send(t), o
                }, we = me;
                ...
                for (var nt = String.fromCharCode, Z = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", Se = {}, at = 0, Ce = Z.length; at < Ce; at++) Se[Z.charAt(at)] = at;
                var Te = function (e) {
                    var t = e.charCodeAt(0);
                    return t < 128 ? e : t < 2048 ? nt(192 | t >>> 6) + nt(128 | t & 63) : nt(224 | t >>> 12 & 15) + nt(128 | t >>> 6 & 63) + nt(128 | t & 63)
                }, Pe = function (e) {
                    return e.replace(/[^\x00-\x7F]/g, Te)
                }, xe = function (e) {
                    var t = [0, 2, 1][e.length % 3],
                        n = e.charCodeAt(0) << 16 | (e.length > 1 ? e.charCodeAt(1) : 0) << 8 | (e.length > 2 ? e.charCodeAt(2) : 0),
                        r = [Z.charAt(n >>> 18), Z.charAt(n >>> 12 & 63), t >= 2 ? "=" : Z.charAt(n >>> 6 & 63), t >= 1 ? "=" : Z.charAt(n & 63)];
                    return r.join("")
                }, Oe = window.btoa || function (e) {
                    return e.replace(/[\s\S]{1,3}/g, xe)
                }, Ae = function () {
                    function e(t, n, r, i) {
                        var o = this;
                ...
                var Q = function (e) {
                    ...
                    function t(n, r) {
                        return e.call(this, setTimeout, Ee, n, function (i) {
                            return r(), null
                        }) || this
                    }
                    ...
                    function t(n, r) {
                        return e.call(this, setInterval, Le, n, function (i) {
                            return r(), i
                        }) || this
                    }
                ...
                function U(e) {
                    ...
                    for (var r = 0; r < t.length; r++) {
                        var i = t[r];
                        for (var o in i) i[o] && i[o].constructor && i[o].constructor === Object ? e[o] = U(e[o] || {}, i[o]) : e[o] = i[o]
                    }
                    return e
                }

                function je() {
                    for (var e = ["Pusher"], t = 0; t < arguments.length; t++) typeof arguments[t] == "string" ? e.push(arguments[t]) : e.push(ct(arguments[t]));
                    return e.join(" : ")
                }
                ...
                function He(e) {
                    return qe(e, function (t) {
                        return typeof t == "object" && (t = ct(t)), encodeURIComponent(ke(t.toString()))
                    })
                }
                ...
                function Me(e) {
                    var t = Mt(e, function (r) {
                        return r !== void 0
                    }), n = Dt(Ue(He(t)), j.method("join", "=")).join("&");
                    return n
                }
                    ...
                    return function r(i, o) {
                        ...
                        switch (typeof i) {
                            case"object":
                                ...
                                if (t.push(i), n.push(o), Object.prototype.toString.apply(i) === "[object Array]") for (_ = [], u = 0; u < i.length; u += 1) _[u] = r(i[u], o + "[" + u + "]"); else {
                                    _ = {};
                                    for (p in i) Object.prototype.hasOwnProperty.call(i, p) && (_[p] = r(i[p], o + "[" + JSON.stringify(p) + "]"))
                                }
                                return _;
                            case"number":
                            case"string":
                ...
                var Fe = function () {
                    ...
                    return e.prototype.debug = function () {
                        ...
                        var i = je.apply(this, arguments);
                        if (xt.log) xt.log(i); else if (xt.logToConsole) {
                            var o = t.bind(this);
                            o(i)
                        }
                    }, e
                }(), A = new Fe, Be = function (e, t, n, r, i) {
                    ...
                    var u = e.getDocument(), p = u.createElement("script");
                    ...
                    return e.prototype.send = function (t) {
                        var n = this, r = "Error loading " + n.src;
                        ...
                        }, n.script.async === void 0 && document.attachEvent && /opera/i.test(navigator.userAgent) ? (n.errorScript = document.createElement("script"), n.errorScript.id = t.id + "_error", n.errorScript.text = t.name + "('" + r + "');", n.script.async = n.errorScript.async = !1) : n.script.async = !0;
                        var i = document.getElementsByTagName("head")[0];
                        i.insertBefore(n.script, i.firstChild), n.errorScript && i.insertBefore(n.errorScript, n.script.nextSibling)
                ...
                }, Ke = {name: "jsonp", getAgent: Qe}, Ye = Ke;
                ...
                var $e = {
                    getInitial: function (e, t) {
                        var n = (t.httpPath || "") + _t(e, "flash=false");
                        return gt("ws", t, n)
                    }
                }, Ze = {
                    getInitial: function (e, t) {
                        var n = (t.httpPath || "/pusher") + _t(e);
                        return gt("http", t, n)
                    }
                }, tn = {
                    getInitial: function (e, t) {
                    ...
                    return e.prototype.get = function (t) {
                        return this._callbacks[bt(t)]
                    }, e.prototype.add = function (t, n, r) {
                        var i = bt(t);
                        this._callbacks[i] = this._callbacks[i] || [], this._callbacks[i].push({fn: n, context: r})
                    }, e.prototype.remove = function (t, n, r) {
                        if (!t && !n && !r) {
                            this._callbacks = {};
                            return
                        }
                        var i = t ? [bt(t)] : Ut(this._callbacks);
                ...
                var rn = function () {
                        function e(t) {
                            this.callbacks = new nn, this.global_callbacks = [], this.failThrough = t
                        }

                        return e.prototype.bind = function (t, n, r) {
                            ...
                            return t ? (this.global_callbacks = Ht(this.global_callbacks || [], function (n) {
                                return n !== t
                            }), this) : (this.global_callbacks = [], this)
                        }, e.prototype.unbind_all = function () {
                            return this.unbind(), this.unbind_global(), this
                        }, e.prototype.emit = function (t, n, r) {
                            for (var i = 0; i < this.global_callbacks.length; i++) this.global_callbacks[i](t, n);
                            var o = this.callbacks.get(t), u = [];
                        ...
                        function t(n, r, i, o, u) {
                            ...
                            return p.initialize = m.transportConnectionInitializer, p.hooks = n, p.name = r, p.priority = i, p.key = o, p.options = u, p.state = "new", p.timeline = u.timeline, p.activityTimeout = u.activityTimeout, p.id = p.timeline.generateUniqueID(), p
                        }
                        ...
                        return t.prototype.handlesActivityChecks = function () {
                            ...
                            var r = this;
                            return this.state === "open" ? (j.defer(function () {
                        ...
                        return e.prototype.isSupported = function (t) {
                            ...
                            return new an(this.hooks, t, n, r, i)
                        }, e
                    }(), tt = cn, un = new tt({
                        urls: $e, handlesActivityChecks: !1, supportsPing: !1, isInitialized: function () {
                        ...
                        urls: Ze, handlesActivityChecks: !1, supportsPing: !0, isInitialized: function () {
                            return !0
                        }
                    }, Bt = U({
                        getSocket: function (e) {
                    ...
                    }, hn = new tt(U({}, Bt, Jt)), ln = new tt(U({}, Xt, Jt)),
                    fn = {ws: un, xhr_streaming: hn, xhr_polling: ln}, ut = fn, pn = new tt({
                        file: "sockjs",
                        urls: tn,
                    ...
                    }, dn = new tt(U({}, Bt, Wt)), vn = new tt(U({}, Xt, Wt));
                ut.xdr_streaming = dn, ut.xdr_polling = vn, ut.sockjs = pn;
                var yn = ut, gn = function () {
                    var e = function (t, n) {
                        return e = Object.setPrototypeOf || {__proto__: []} instanceof Array && function (r, i) {
                            r.__proto__ = i
                        } || function (r, i) {
                ...
                }(V), bn = new _n, mn = function () {
                    function e(t, n, r) {
                        this.manager = t, this.transport = n, this.minPingDelay = r.minPingDelay, this.maxPingDelay = r.maxPingDelay, this.pingDelay = void 0
                    }

                    return e.prototype.createConnection = function (t, n, r, i) {
                        var o = this;
                        i = U({}, i, {activityTimeout: this.pingDelay});
                        var u = this.transport.createConnection(t, n, r, i), p = null, _ = function () {
                            u.unbind("open", _), u.bind("closed", g), p = j.now()
                        }, g = function (k) {
                            if (u.unbind("closed", g), k.code === 1002 || k.code === 1003) o.manager.reportDeath(); else if (!k.wasClean && p) {
                                var E = j.now() - p;
                    ...
                    decodeMessage: function (e) {
                        ...
                        if (t.event === "pusher:connection_established") {
                            ...
                            if (t.event === "pusher:error") return {
                    ...
                    function t(n, r) {
                        ...
                        return i.id = n, i.transport = r, i.activityTimeout = r.activityTimeout, i.bindListeners(), i
                    }
                    ...
                    return t.prototype.handlesActivityChecks = function () {
                        ...
                        return i && (o.channel = i), A.debug("Event sent", o), this.send(K.encodeMessage(o))
                    }, t.prototype.ping = function () {
                        ...
                        var n = this, r = {
                            message: function (o) {
                                ...
                                try {
                                    ...
                                    n.emit("error", {type: "MessageParseError", error: p, data: o.data})
                                }
                                if (u !== void 0) {
                                ...
                                i(), o && o.code && n.handleCloseEvent(o), n.transport = null, n.emit("closed")
                            }
                        }, i = function () {
                            W(r, function (o, u) {
                    ...
                    return e.prototype.close = function () {
                        ...
                        this.onMessage = function (n) {
                            ...
                            r.action === "connected" ? t.finish("connected", {
                                connection: new Cn(r.id, t.transport),
                                activityTimeout: r.activityTimeout
                            }) : (t.finish(r.action, {error: r.error}), t.transport.close())
                        }, this.onClosed = function (n) {
                            t.unbindListeners();
                            var r = K.getCloseAction(n) || "backoff", i = K.getCloseError(n);
                            t.finish(r, {error: i})
                    ...
                    function t(n, r) {
                        var i = e.call(this, function (o, u) {
                            A.debug("No callbacks on " + n + " for " + o)
                        }) || this;
                        return i.name = n, i.pusher = r, i.subscribed = !1, i.subscriptionPending = !1, i.subscriptionCancelled = !1, i
                    }

                    return t.prototype.authorize = function (n, r) {
                        return r(null, {auth: ""})
                    }, t.prototype.trigger = function (n, r) {
                        if (n.indexOf("client-") !== 0) throw new w("Event '" + n + "' does not start with 'client-'");
                        if (!this.subscribed) {
                            var i = b.buildLogSuffix("triggeringClientEvents");
                            A.warn("Client event triggered before channel 'subscription_succeeded' event . " + i)
                        }
                        ...
                        var r = n.event, i = n.data;
                        if (r === "pusher_internal:subscription_succeeded") this.handleSubscriptionSucceededEvent(n); else if (r === "pusher_internal:subscription_count") this.handleSubscriptionCountEvent(n); else if (r.indexOf("pusher_internal:") !== 0) {
                            var o = {};
                            this.emit(r, i, o)
                        }
                        ...
                        var n = this;
                        this.subscribed || (this.subscriptionPending = !0, this.subscriptionCancelled = !1, this.authorize(this.pusher.connection.socket_id, function (r, i) {
                            r ? (n.subscriptionPending = !1, A.error(r.toString()), n.emit("pusher:subscription_error", Object.assign({}, {
                                type: "AuthError",
                                error: r.message
                            }, r instanceof B ? {status: r.status} : {}))) : n.pusher.send_event("pusher:subscribe", {
                                auth: i.auth,
                    ...
                    function _(g) {
                        ...
                        for (; n;) try {
                            if (r = 1, i && (o = g[0] & 2 ? i.return : g[0] ? i.throw || ((o = i.return) && o.call(i), 0) : i.next) && !(o = o.call(i, g[1])).done) return o;
                            switch (i = 0, o && (g = [g[0] & 2, o.value]), g[0]) {
                                ...
                                case 7:
                                    ...
                                    continue;
                                default:
                                    if (o = n.trys, !(o = o.length > 0 && o[o.length - 1]) && (g[0] === 6 || g[0] === 2)) {
                                        n = 0;
                                        continue
                                    }
                    ...
                    function t(n, r) {
                        ...
                        return i.members = new jn, i
                    }

                    return t.prototype.authorize = function (n, r) {
                        var i = this;
                        e.prototype.authorize.call(this, n, function (o, u) {
                            return qn(i, void 0, void 0, function () {
                                var p, _;
                                return Un(this, function (g) {
                                    switch (g.label) {
                                        case 0:
                                            return o ? [3, 3] : (u = u, u.channel_data == null ? [3, 1] : (p = JSON.parse(u.channel_data), this.members.setMyID(p.user_id), [3, 3]));
                                        case 1:
                                            return [4, this.pusher.user.signinDonePromise];
                                        case 2:
                                            if (g.sent(), this.pusher.user.user_data != null) this.members.setMyID(this.pusher.user.user_data.id); else return _ = b.buildLogSuffix("authorizationEndpoint"), A.error("Invalid auth response for channel '" + this.name + "', " + ("expected 'channel_data' field. " + _ + ", ") + "or the user should be signed in."), r("Invalid auth response"), [2];
                                            g.label = 3;
                                        case 3:
                                            return r(o, u), [2]
                                    }
                        ...
                        var r = n.event;
                        if (r.indexOf("pusher_internal:") === 0) this.handleInternalEvent(n); else {
                            var i = n.data, o = {};
                ...
                }(wt), Hn = Dn, Mn = a(1), kt = a(0), zn = function () {
                    var e = function (t, n) {
                        return e = Object.setPrototypeOf || {__proto__: []} instanceof Array && function (r, i) {
                            r.__proto__ = i
                        } || function (r, i) {
                    ...
                    return t.prototype.authorize = function (n, r) {
                        ...
                        e.prototype.authorize.call(this, n, function (o, u) {
                            ...
                            if (!p) {
                                r(new Error("No shared_secret key in auth payload for encrypted channel: " + i.name), null);
                                return
                            }
                            i.key = Object(kt.decode)(p), delete u.shared_secret, r(null, u)
                        })
                    }, t.prototype.trigger = function (n, r) {
                        ...
                        if (!r.ciphertext || !r.nonce) {
                            A.error("Unexpected format for encrypted event, expected object with `ciphertext` and `nonce` fields, got: " + r);
                            return
                        }
                        var o = Object(kt.decode)(r.ciphertext);
                        if (o.length < this.nacl.secretbox.overheadLength) {
                            A.error("Expected encrypted event ciphertext length to be " + this.nacl.secretbox.overheadLength + ", got: " + o.length);
                            return
                        }
                        var u = Object(kt.decode)(r.nonce);
                        if (u.length < this.nacl.secretbox.nonceLength) {
                            A.error("Expected encrypted event nonce length to be " + this.nacl.secretbox.nonceLength + ", got: " + u.length);
                            return
                        }
                        var p = this.nacl.secretbox.open(o, u, this.key);
                        if (p === null) {
                            A.debug("Failed to decrypt an event, probably because it was encrypted with a different key. Fetching a new key from the authEndpoint..."), this.authorize(this.pusher.connection.socket_id, function (_, g) {
                                if (_) {
                                    A.error("Failed to make a request to the authEndpoint: " + g + ". Unable to fetch new key, so dropping encrypted event");
                                    return
                                }
                    ...
                    function t(n, r) {
                        var i = e.call(this) || this;
                        i.state = "initialized", i.connection = null, i.key = n, i.options = r, i.timeline = i.options.timeline, i.usingTLS = i.options.useTLS, i.errorCallbacks = i.buildErrorCallbacks(), i.connectionCallbacks = i.buildConnectionCallbacks(i.errorCallbacks), i.handshakeCallbacks = i.buildHandshakeCallbacks(i.errorCallbacks);
                        var o = m.getNetwork();
                        return o.bind("online", function () {
                            i.timeline.info({netinfo: "online"}), (i.state === "connecting" || i.state === "unavailable") && i.retryIn(0)
                    ...
                    return t.prototype.connect = function () {
                        ...
                        var n = this, r = function (i, o) {
                            i ? n.runner = n.strategy.connect(0, r) : o.action === "error" ? (n.emit("error", {
                                type: "HandshakeError",
                                error: o.error
                            }), n.timeline.error({handshakeError: o.error})) : (n.abortConnecting(), n.handshakeCallbacks[o.action](o))
                        };
                        ...
                        this.timeline.info({
                            action: "retry",
                            delay: n
                        }), n > 0 && this.emit("connecting_in", Math.round(n / 1e3)), this.retryTimer = new Q(n || 0, function () {
                        ...
                        var n = this;
                        this.stopActivityCheck(), this.connection.ping(), this.activityTimer = new Q(this.options.pongTimeout, function () {
                            n.timeline.error({pong_timed_out: n.options.pongTimeout}), n.retryIn(0)
                        })
                    }, t.prototype.resetActivityCheck = function () {
                        var n = this;
                        this.stopActivityCheck(), this.connection && !this.connection.handlesActivityChecks() && (this.activityTimer = new Q(this.activityTimeout, function () {
                            n.sendActivityCheck()
                        }))
                        ...
                        return U({}, n, {
                            connected: function (i) {
                                r.activityTimeout = Math.min(r.options.activityTimeout, i.activityTimeout, i.connection.activityTimeout || 1 / 0), r.clearUnavailableTimer(), r.setConnection(i.connection), r.socket_id = r.connection.id, r.updateState("connected", {socket_id: r.socket_id})
                            }
                        })
                    }, t.prototype.buildErrorCallbacks = function () {
                        var n = this, r = function (i) {
                            return function (o) {
                                o.error && n.emit("error", {type: "WebSocketError", error: o.error}), i(o)
                            }
                        };
                        return {
                            tls_only: r(function () {
                        ...
                        this.connection = n;
                        for (var r in this.connectionCallbacks) this.connection.bind(r, this.connectionCallbacks[r]);
                        this.resetActivityCheck()
                    }, t.prototype.abandonConnection = function () {
                        if (this.connection) {
                            this.stopActivityCheck();
                            for (var n in this.connectionCallbacks) this.connection.unbind(n, this.connectionCallbacks[n]);
                        ...
                        if (this.state = n, i !== n) {
                            var o = n;
                            o === "connected" && (o += " with new socket ID " + r.socket_id), A.debug("State changed", i + " -> " + o), this.timeline.info({
                                state: n,
                                params: r
                            }), this.emit("state_change", {previous: i, current: n}), this.emit(n, r)
                        }
                    ...
                    return e.prototype.add = function (t, n) {
                        return this.channels[t] || (this.channels[t] = Qn(t, n)), this.channels[t]
                    }, e.prototype.all = function () {
                        return Ne(this.channels)
                ...
                var Kn = {
                    ...
                    return e.prototype.isSupported = function () {
                        ...
                        var r = this, i = this.strategies, o = 0, u = this.timeout, p = null, _ = function (g, k) {
                            k ? n(null, k) : (o = o + 1, r.loop && (o = o % i.length), o < i.length ? (u && (u = u * 2, r.timeoutLimit && (u = Math.min(u, r.timeoutLimit))), p = r.tryStrategy(i[o], t, {
                                timeout: u,
                                failFast: r.failFast
                            }, _)) : n(!0))
                        };
                        return p = this.tryStrategy(i[o], t, {
                            timeout: u,
                        ...
                        var o = null, u = null;
                        return r.timeout > 0 && (o = new Q(r.timeout, function () {
                            u.abort(), i(!0)
                        })), u = t.connect(n, function (p, _) {
                            p && o && o.isRunning() && !r.failFast || (o && o.ensureAborted(), i(p, _))
                        }), {
                            abort: function () {
                    ...
                    return e.prototype.isSupported = function () {
                        ...
                        return tr(this.strategies, t, function (r, i) {
                            return function (o, u) {
                                if (i[r].error = o, o) {
                                    er(i) && n(!0);
                                    return
                ...
                var rr = function () {
                    ...
                    return e.prototype.isSupported = function () {
                        ...
                        var r = this.usingTLS, i = or(r), o = [this.strategy];
                        ...
                        var p = j.now(), _ = o.pop().connect(t, function g(k, E) {
                            k ? (Qt(r), o.length > 0 ? (p = j.now(), _ = o.pop().connect(t, g)) : n(k)) : (sr(r, E.transport.name, j.now() - p), n(null, E))
                        });
                        return {
                            abort: function () {
                                _.abort()
                ...
                function sr(e, t, n) {
                    ...
                    if (r) try {
                        r[Ct(e)] = ct({timestamp: j.now(), transport: t, latency: n})
                    } catch {
                    }
                }
                ...
                var ar = function () {
                    ...
                    return e.prototype.isSupported = function () {
                        ...
                        var r = this.strategy, i, o = new Q(this.options.delay, function () {
                            i = r.connect(t, n)
                        });
                        return {
                            abort: function () {
                ...
                var lr = function (e, t, n) {
                    ...
                    function i(ce, _i, bi, mi, wi) {
                        var ue = n(e, ce, _i, bi, mi, wi);
                        return r[ce] = ue, ue
                    }
                    ...
                    var o = Object.assign({}, t, {
                            ...
                            httpPath: e.wsPath
                        }), u = Object.assign({}, o, {useTLS: !0}), p = Object.assign({}, t, {
                        ...
                        E = i("ws", "ws", 3, o, g), X = i("wss", "ws", 3, u, g), pi = i("sockjs", "sockjs", 1, p),
                        ne = i("xhr_streaming", "xhr_streaming", 1, p, k),
                        di = i("xdr_streaming", "xdr_streaming", 1, p, k), re = i("xhr_polling", "xhr_polling", 1, p),
                        vi = i("xdr_polling", "xdr_polling", 1, p), ie = new Y([E], _), yi = new Y([X], _),
                        gi = new Y([pi], _), oe = new Y([new it(ot(ne), ne, di)], _),
                        se = new Y([new it(ot(re), re, vi)], _),
                        ae = new Y([new it(ot(oe), new St([oe, new ht(se, {delay: 4e3})]), se)], _),
                        Ot = new it(ot(ae), ae, gi), At;
                    return t.useTLS ? At = new St([ie, new ht(Ot, {delay: 2e3})]) : At = new St([ie, new ht(yi, {delay: 2e3}), new ht(Ot, {delay: 5e3})]), new ir(new hr(new it(ot(E), At, Ot)), r, {
                        ttl: 18e5,
                        timeline: t.timeline,
                        useTLS: t.useTLS
                    })
                    ...
                    return t.prototype.start = function (n) {
                        ...
                        this.position = 0, this.xhr = this.hooks.getRequest(this), this.unloader = function () {
                            r.close()
                        }, m.addUnloadListener(this.unloader), this.xhr.open(this.method, this.url, !0), this.xhr.setRequestHeader && this.xhr.setRequestHeader("Content-Type", "application/json"), this.xhr.send(n)
                    }, t.prototype.close = function () {
                        this.unloader && (m.removeUnloadListener(this.unloader), this.unloader = null), this.xhr && (this.hooks.abortRequest(this.xhr), this.xhr = null)
                    }, t.prototype.onChunk = function (n, r) {
                        for (; ;) {
                            var i = this.advanceBuffer(r);
                            if (i) this.emit("chunk", {status: n, data: i}); else break
                        }
                        this.isBufferTooLong(r) && this.emit("buffer_too_long")
                    }, t.prototype.advanceBuffer = function (n) {
                        var r = n.slice(this.position), i = r.indexOf(`
`);
                        return i !== -1 ? (this.position += i + 1, r.slice(0, i)) : null
                    }, t.prototype.isBufferTooLong = function (n) {
                        return this.position === n.length && n.length > gr
                    }, t
                }(V), br = _r, Tt;
                (function (e) {
                    e[e.CONNECTING = 0] = "CONNECTING", e[e.OPEN = 1] = "OPEN", e[e.CLOSED = 3] = "CLOSED"
                })(Tt || (Tt = {}));
                var $ = Tt, mr = 1, wr = function () {
                    function e(t, n) {
                        this.hooks = t, this.session = Yt(1e3) + "/" + Tr(8), this.location = kr(n), this.readyState = $.CONNECTING, this.openStream()
                    }
                    ...
                    return e.prototype.send = function (t) {
                        ...
                        if (this.readyState === $.OPEN) try {
                            return m.createSocketRequest("POST", Kt(Sr(this.location, this.session))).start(t), !0
                        } catch {
                            return !1
                        } else return !1
                        ...
                        this.closeStream(), this.readyState = $.CLOSED, this.onclose && this.onclose({
                            code: t,
                            reason: n,
                            wasClean: r
                        })
                        ...
                        this.readyState === $.CONNECTING ? (t && t.hostname && (this.location.base = Cr(this.location.base, t.hostname)), this.readyState = $.OPEN, this.onopen && this.onopen()) : this.onClose(1006, "Server lost session", !0)
                        ...
                        var t = this;
                        this.stream = m.createSocketRequest("POST", Kt(this.hooks.getReceiveURL(this.location, this.session))), this.stream.bind("chunk", function (n) {
                            t.onChunk(n)
                ...
                var jr = $t, Nr = {
                    ...
                    getDefaultStrategy: fr,
                    Transports: yn,
                    transportConnectionInitializer: pr,
                    HTTPFactory: jr,
                    TimelineTransport: Ye,
                    getXHRAPI: function () {
                    ...
                    randomInt: function (e) {
                        var t = function () {
                            var n = window.crypto || window.msCrypto, r = n.getRandomValues(new Uint32Array(1))[0];
                ...
                var lt = Pt, qr = function () {
                    function e(t, n, r) {
                        this.key = t, this.session = n, this.events = [], this.options = r || {}, this.sent = 0, this.uniqueID = 0
                    }

                    return e.prototype.log = function (t, n) {
                        t <= this.options.level && (this.events.push(U({}, n, {timestamp: j.now()})), this.options.limit && this.events.length > this.options.limit && this.events.shift())
                        ...
                        return this.events = [], t(i, function (o, u) {
                            o || r.sent++, n && n(o, u)
                        }), !0
                ...
                var Mr = m.Transports, zr = function (e, t, n, r, i, o) {
                    var u = Mr[n];
                    if (!u) throw new F(n);
                    var p = (!e.enabledTransports || qt(e.enabledTransports, t) !== -1) && (!e.disabledTransports || qt(e.disabledTransports, t) === -1),
                        _;
                    return p ? (i = Object.assign({ignoreNullOrigin: e.ignoreNullOrigin}, i), _ = new Hr(t, r, o ? o.getAssistant(u) : u, i)) : _ = Fr, _
                }, Fr = {
                    isSupported: function () {
                        return !1
                    ...
                    if (typeof m.getAuthorizers()[e.transport] > "u") throw "'" + e.transport + "' is not a recognized auth transport";
                    return function (t, n) {
                        var r = Br(t, e);
                        m.getAuthorizers()[e.transport](m, r, e, v.UserAuthentication, n)
                    }
                }, Jr = Xr, Wr = function (e, t) {
                    var n = "socket_id=" + encodeURIComponent(e.socketId);
                    ...
                    return function (i, o) {
                        var u = e.channel(i.channelName), p = n(u, r);
                ...
                function Kr(e, t) {
                    var n = {
                        ...
                        useTLS: Zr(e),
                        wsHost: $r(e),
                        userAuthenticator: ei(e),
                        channelAuthorizer: ri(e, t)
                    };
                ...
                function ei(e) {
                    ...
                    return "customHandler" in t && t.customHandler != null ? t.customHandler : Jr(t)
                }

                function ni(e, t) {
                    var n;
                    return "channelAuthorization" in e ? n = et(et({}, d.channelAuthorization), e.channelAuthorization) : (n = {
                        transport: e.authTransport || d.authTransport,
                        endpoint: e.authEndpoint || d.authEndpoint
                    }, "auth" in e && ("params" in e.auth && (n.params = e.auth.params), "headers" in e.auth && (n.headers = e.auth.headers)), "authorizer" in e && (n.customHandler = Qr(t, n, e.authorizer))), n
                }

                function ri(e, t) {
                    var n = ni(e, t);
                    return "customHandler" in n && n.customHandler != null ? n.customHandler : Gr(n)
                }
                ...
                var ii = function () {
                    ...
                    function t(n) {
                        var r = e.call(this, function (i, o) {
                ...
                var ci = ai, ui = function () {
                    ...
                    function t(n) {
                        ...
                        return r.signin_requested = !1, r.user_data = null, r.serverToUserChannel = null, r.signinDonePromise = null, r._signinDoneResolve = null, r._onAuthorize = function (i, o) {
                            if (i) {
                                A.warn("Error during signin: " + i), r._cleanup();
                                return
                            }
                            r.pusher.send_event("pusher:signin", {auth: o.auth, user_data: o.user_data})
                        }, r.pusher = n, r.pusher.connection.bind("state_change", function (i) {
                            var o = i.previous, u = i.current;
                            o !== "connected" && u === "connected" && r._signin(), o === "connected" && u !== "connected" && (r._cleanup(), r._newSigninPromiseIfNeeded())
                        }), r.watchlist = new si(n), r.pusher.connection.bind("message", function (i) {
                            var o = i.event;
                            o === "pusher:signin_success" && r._onSigninSuccess(i.data), r.serverToUserChannel && r.serverToUserChannel.name === i.channel && r.serverToUserChannel.handleEvent(i)
                        }), r
                    }
                    ...
                    return t.prototype.signin = function () {
                        ...
                        try {
                            ...
                            A.error("Failed parsing user data after signin: " + n.user_data), this._cleanup();
                            return
                        }
                        ...
                        var n = this, r = function (i) {
                            i.subscriptionPending && i.subscriptionCancelled ? i.reinstateSubscription() : !i.subscriptionPending && n.pusher.connection.state === "connected" && i.subscribe()
                        };
                        this.serverToUserChannel = new mt("#server-to-user-" + this.user_data.id, this.pusher), this.serverToUserChannel.bind_global(function (i, o) {
                            i.indexOf("pusher_internal:") === 0 || i.indexOf("pusher:") === 0 || n.emit(i, o)
                        ...
                        if (this.signin_requested && !(this.signinDonePromise && !this.signinDonePromise.done)) {
                            var n = ci(), r = n.promise, i = n.resolve, o = n.reject;
                            r.done = !1;
                            var u = function () {
                                r.done = !0
                            };
                    ...
                    function e(t, n) {
                        var r = this;
                        if (fi(t), n = n || {}, !n.cluster && !(n.wsHost || n.httpHost)) {
                            var i = b.buildLogSuffix("javascriptQuickStart");
                            A.warn("You should always specify a cluster when connecting. " + i)
                        }
                        "disableStats" in n && A.warn("The disableStats option is deprecated in favor of enableStats"), this.key = t, this.config = Kr(n, this), this.channels = G.createChannels(), this.global_emitter = new V, this.sessionID = m.randomInt(1e9), this.timeline = new Ur(this.key, this.sessionID, {
                            ...
                            level: lt.INFO,
                            version: d.VERSION
                        }), this.config.enableStats && (this.timelineSender = G.createTimelineSender(this.timeline, {
                            host: this.config.statsHost,
                            path: "/timeline/v2/" + m.TimelineTransport.name
                        }));
                        var o = function (u) {
                            return m.getDefaultStrategy(r.config, u, zr)
                        };
                        this.connection = G.createConnectionManager(this.key, {
                            ...
                            var p = u.event, _ = p.indexOf("pusher_internal:") === 0;
                            if (u.channel) {
                            ...
                            A.warn(u)
                        }), e.instances.push(this), this.timeline.info({instances: e.instances.length}), this.user = new li(this), e.isReady && this.connect()
                    }
                    ...
                    return e.ready = function () {
                        ...
                        return Ut(Mt({ws: m.Transports.ws}, function (t) {
                            return t.isSupported({})
                        }))
                        ...
                        if (this.connection.connect(), this.timelineSender && !this.timelineSenderTimer) {
                            ...
                            this.timelineSenderTimer = new Re(6e4, function () {
                                n.send(t)
                            })
                        }
                    }, e.prototype.disconnect = function () {
    ...
    function ft(l) {
        ...
        return ft = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function (h) {
            return typeof h
        } : function (h) {
    ...
    function st() {
        return st = Object.assign || function (l) {
    ...
    function D(l, h) {
        ...
        }), Object.defineProperty(l, "prototype", {writable: !1}), h && Et(l, h)
    }

    function pt(l) {
        return pt = Object.setPrototypeOf ? Object.getPrototypeOf : function (a) {
            return a.__proto__ || Object.getPrototypeOf(a)
        }, pt(l)
    }

    function Et(l, h) {
        return Et = Object.setPrototypeOf || function (c, s) {
    ...
    var Lt = function () {
        ...
        return R(l, [{
            key: "listenForWhisper", value: function (a, c) {
                return this.listen(".client-" + a, c)
            }
        }, {
            key: "notification", value: function (a) {
                return this.listen(".Illuminate\\Notifications\\Events\\BroadcastNotificationCreated", a)
            }
        }, {
            key: "stopListeningForWhisper", value: function (a, c) {
        ...
        return R(l, [{
            key: "format", value: function (a) {
                return [".", "\\"].includes(a.charAt(0)) ? a.substring(1) : (this.namespace && (a = this.namespace + "." + a), a.replace(/\./g, "\\"))
            }
        }, {
            key: "setNamespace", value: function (a) {
                this.namespace = a
            }
        }]), l
    }(), vt = function (l) {
        ...
        function a(c, s, f) {
            var d;
            return L(this, a), d = h.call(this), d.name = s, d.pusher = c, d.options = f, d.eventFormatter = new de(d.options.namespace), d.subscribe(), d
        }
        ...
        return R(a, [{
            ...
            key: "stopListening", value: function (s, f) {
                return f ? this.subscription.unbind(this.eventFormatter.format(s), f) : this.subscription.unbind(this.eventFormatter.format(s)), this
            }
        }, {
            ...
            key: "error", value: function (s) {
                return this.on("pusher:subscription_error", function (f) {
                    s(f)
                }), this
            }
        }, {
            key: "on", value: function (s, f) {
        ...
        return R(a, [{
            key: "whisper", value: function (s, f) {
        ...
        return R(a, [{
            key: "here", value: function (s) {
                return this.on("pusher:subscription_succeeded", function (f) {
                    s(Object.keys(f.members).map(function (d) {
                        return f.members[d]
                    }))
                }), this
            }
            ...
            key: "joining", value: function (s) {
                return this.on("pusher:member_added", function (f) {
                    s(f.info)
                }), this
            }
        }, {
            ...
            key: "leaving", value: function (s) {
                return this.on("pusher:member_removed", function (f) {
                    s(f.info)
                }), this
            }
        }]), a
        ...
        function a(c, s, f) {
            var d;
            return L(this, a), d = h.call(this), d.events = {}, d.listeners = {}, d.name = s, d.socket = c, d.options = f, d.eventFormatter = new de(d.options.namespace), d.subscribe(), d
        }
        ...
        return R(a, [{
            ...
            key: "subscribed", value: function (s) {
                return this.on("connect", function (f) {
                    s(f)
                }), this
            }
        }, {
            ...
            key: "on", value: function (s, f) {
                var d = this;
                return this.listeners[s] = this.listeners[s] || [], this.events[s] || (this.events[s] = function (N, P) {
                    d.name === N && d.listeners[s] && d.listeners[s].forEach(function (T) {
                        return T(P)
                    })
                }, this.socket.on(s, this.events[s])), this.listeners[s].push(f), this
            }
        }, {
            ...
            key: "unbindEvent", value: function (s, f) {
                this.listeners[s] = this.listeners[s] || [], f && (this.listeners[s] = this.listeners[s].filter(function (d) {
                    return d !== f
        ...
        return R(a, [{
            key: "here", value: function (s) {
                return this.on("presence:subscribed", function (f) {
                    s(f.map(function (d) {
                        return d.user_info
                    }))
                }), this
            ...
            key: "joining", value: function (s) {
                return this.on("presence:joining", function (f) {
            ...
            key: "leaving", value: function (s) {
                return this.on("presence:leaving", function (f) {
                    return s(f.user_info)
                }), this
            }
        }]), a
        ...
        function l(h) {
            ...
            }, this.setOptions(h), this.connect()
        }

        return R(l, [{
            key: "setOptions", value: function (a) {
                this.options = st(this._defaultOptions, a);
                var c = this.csrfToken();
                return c && (this.options.auth.headers["X-CSRF-TOKEN"] = c, this.options.userAuthentication.headers["X-CSRF-TOKEN"] = c), c = this.options.bearerToken, c && (this.options.auth.headers.Authorization = "Bearer " + c, this.options.userAuthentication.headers.Authorization = "Bearer " + c), a
            }
        }, {
        ...
        return R(a, [{
            ...
            key: "listen", value: function (s, f, d) {
                return this.channel(s).listen(f, d)
            }
        }, {
            key: "channel", value: function (s) {
                return this.channels[s] || (this.channels[s] = new vt(this.pusher, s, this.options)), this.channels[s]
            }
        }, {
            key: "privateChannel", value: function (s) {
                return this.channels["private-" + s] || (this.channels["private-" + s] = new Ii(this.pusher, "private-" + s, this.options)), this.channels["private-" + s]
            }
        }, {
            key: "encryptedPrivateChannel", value: function (s) {
                return this.channels["private-encrypted-" + s] || (this.channels["private-encrypted-" + s] = new ji(this.pusher, "private-encrypted-" + s, this.options)), this.channels["private-encrypted-" + s]
            }
        }, {
            key: "presenceChannel", value: function (s) {
                return this.channels["presence-" + s] || (this.channels["presence-" + s] = new Ni(this.pusher, "presence-" + s, this.options)), this.channels["presence-" + s]
            }
        }, {
            key: "leave", value: function (s) {
                var f = this, d = [s, "private-" + s, "private-encrypted-" + s, "presence-" + s];
        ...
        return R(a, [{
            key: "connect", value: function () {
                var s = this, f = this.getSocketIO();
                return this.socket = f(this.options.host, this.options), this.socket.on("reconnect", function () {
            ...
            key: "channel", value: function (s) {
                return this.channels[s] || (this.channels[s] = new ve(this.socket, s, this.options)), this.channels[s]
            }
        }, {
            key: "privateChannel", value: function (s) {
                return this.channels["private-" + s] || (this.channels["private-" + s] = new ye(this.socket, "private-" + s, this.options)), this.channels["private-" + s]
            }
        }, {
            key: "presenceChannel", value: function (s) {
                return this.channels["presence-" + s] || (this.channels["presence-" + s] = new qi(this.socket, "presence-" + s, this.options)), this.channels["presence-" + s]
            }
        }, {
            key: "leave", value: function (s) {
                var f = this, d = [s, "private-" + s, "presence-" + s];
        ...
        return R(l, [{
            key: "channel", value: function (a) {
                return this.connector.channel(a)
            }
        }, {
            key: "connect", value: function () {
                if (this.options.broadcaster == "reverb") this.connector = new pe(st(st({}, this.options), {cluster: ""})); else if (this.options.broadcaster == "pusher") this.connector = new pe(this.options); else if (this.options.broadcaster == "socket.io") this.connector = new Di(this.options); else if (this.options.broadcaster == "null") this.connector = new Hi(this.options); else if (typeof this.options.broadcaster == "function") this.connector = new this.options.broadcaster(this.options); else throw new Error("Broadcaster ".concat(ft(this.options.broadcaster), " ").concat(this.options.broadcaster, " is not supported."))
            }
        }, {
            key: "disconnect", value: function () {
            ...
            key: "listen", value: function (a, c, s) {
                return this.connector.listen(a, c, s)
            }
        }, {
            key: "private", value: function (a) {
                return this.connector.privateChannel(a)
            }
        }, {
            key: "encryptedPrivate", value: function (a) {
            ...
            key: "registerInterceptors", value: function () {
                typeof Vue == "function" && Vue.http && this.registerVueRequestInterceptor(), typeof axios == "function" && this.registerAxiosRequestInterceptor(), typeof jQuery == "function" && this.registerjQueryAjaxSetup(), (typeof Turbo > "u" ? "undefined" : ft(Turbo)) === "object" && this.registerTurboRequestInterceptor()
            }
        }, {
            ...
            key: "registerjQueryAjaxSetup", value: function () {
                var a = this;
                typeof jQuery.ajax < "u" && jQuery.ajaxPrefilter(function (c, s, f) {
